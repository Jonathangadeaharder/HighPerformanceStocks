...
Crucially, adjusting for uncertainty is **directionally agnostic**. Uncertainty does not automatically equal "reduce expected returns and play it safe." If the data and mathematical logic indicate the market is systematically _underestimating_ an asset class, we adjust the EV _upwards_ and increase our aggression.
